...
$(document).ready(function() {
	$("#dialog-NewParty").dialog({
		...
		buttons : {
			"Save" : function() {
				...
				var grid = $("#divPartyInputs").data("kendoGrid");

				grid.dataSource.add({
					Name : name,
					Description : description,
					Nummer : "00000001",
					Contactperson : "Jackey"
				});

				$("#dialog-NewParty").dialog('close');
			}
		}
	});

	$("#dialog-NewPerson").dialog({
		title : 'Nieuw Persoon',
		autoOpen : false,
		modal : true,
		buttons : {
			"Save" : function() {
				...
				var grid = $("#divPersonInputs").data("kendoGrid");
	...
	$(".imgDeletePartyConfirm").click(function() {
		$("#divDeleteConfirmation").dialog('open');
	});

	$("#divPersonInputs").kendoGrid({
		dataSource : {
