...
(function (a, b) {
    ...
    c.initWidget = function (d, e, f) {
        ...
        progress: function (b, c) {
            ...
            c ? d.length || (d = a("<div class='k-loading-mask'><span class='k-loading-text'>Loading...</span><div class='k-loading-image'/><div class='k-loading-color'/></div>").width("100%").height("100%").prependTo(b).css({
                top: b.scrollTop(),
                left: b.scrollLeft()
            })) : d && d.remove()
        },
    ...
    var c = window.kendo,
        ...
        p = d.extend({
            ...
            _onFileProgress: function (b, c) {
                ...
                d.length == 0 && (d = a("<span class='k-progress'><span class='k-state-selected k-progress-status' style='width: 0;'></span></span>").appendTo(a(".k-filename", b.target)).find(".k-progress-status")), d.width(c + "%"), this.trigger(n, {
